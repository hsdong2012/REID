...
import caffe
from experiments_py.exper_cuhk.cuhk01.cuhk01_SeqIn import *
...
video_instance.initialize('train', False, Train_batch_size, Train_frames_l, 3, 160, 80, path_root, TrainVideolist,multylabel,affine,balance,multylabel)
video_testInstance.initialize('train', False, Test_batch_size , Test_frames_l, 3, 160, 80, path_root, TestVideolist,multylabel,affine,balance,multylabel)
video_instance.setup()
video_testInstance.setup()

SOLVER_PATH = 'experiments_py/exper_cuhk/cuhk01/ID_aware_Test/solver.prototxt'
caffe.set_device(0)
caffe.set_mode_gpu()
