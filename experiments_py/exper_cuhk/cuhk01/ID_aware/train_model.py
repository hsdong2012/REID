...
video_instance.initialize('train', False, Train_batch_size, Train_frames_l, 3, 160, 80, path_root, TrainVideolist,multylabel,affine,balance)
video_testInstance.initialize('test', False, Test_batch_size , Test_frames_l, 3, 160, 80, path_root, TestVideolist,multylabel,affine,balance)
video_instance.setup()
video_testInstance.setup()

SOLVER_PATH = 'experiments_py/exper_cuhk/cuhk01/LstmNetTest/lstm_solver_RGB.prototxt'
caffe.set_device(0)
caffe.set_mode_gpu()
