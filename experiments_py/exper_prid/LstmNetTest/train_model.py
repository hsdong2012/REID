...
import caffe
from experiments_py.exper_cuhk.cuhk03.cuhk03_SeqIn import *
...
TrainVideolist ='dataset/cuhk03/split/img_seq/set01_train_noval_pair.txt'
TestVideolist ='dataset/cuhk03/split/img_seq/set01_test_noval_pair.txt'
Num_list = 'dataset/cuhk03/split/totalNumListDict.txt'
TrainVideolistFlow =''
TestVideolistFlow =''
multylabel = False
affine = True
...
SOLVER_PATH = 'experiments_py/exper_cuhk/cuhk03/LstmNetTest/lstm_solver_RGB.prototxt'
caffe.set_device(0)
caffe.set_mode_gpu()
